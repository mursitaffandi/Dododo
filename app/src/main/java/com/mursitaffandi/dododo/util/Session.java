...
import com.mursitaffandi.dododo.view.LoginActivity;
...
public class Session {
    ...
    private static final String PREFER_NAME = "DOdodo_Pref";
    ...
    public void createUserLoginSession(String token, String no_hp){
